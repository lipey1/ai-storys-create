...
async function uploadInstagramStories(browser, videoPath) {
    try {
        ...
        await page.goto('https://business.facebook.com/latest/story_composer/', {
        ...
        console.log(' ○'.green + ' Publicação de story concluída!');

    } catch (error) {
        console.log(' ○'.red + ' Ocorreu um erro ao publicar vídeo no Instagram Story:', error.message);
    } finally {
        try {
            await page.close();
            console.log(' ○'.blue + ' Página do Instagram Story fechada com sucesso'.white);
        } catch { }
    }
}

export default uploadInstagramStories;